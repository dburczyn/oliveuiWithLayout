  ...
  OliveUI.modules.new_brokerage_object_training_widget = function (config = {}) {
    ...
    var returned = {
      ...
      render: function (renderdata, gridrendercontent) {
        ...
        trainingtileinstance = renderdata;
    ...
    function produceWidgetInstanceContent() {
      ...
      widgetInstanceContent.picture = $(trainingpicturefield).val();
    ...
    function createFrontWidgetTile(gridrendercontent) {
      var parsedcreatedat = new Date(parseInt(trainingtileinstance.createdat)).toLocaleDateString(trainingStatics.locale, trainingStatics.localeOptions);
      var parsedupdatedat = new Date(parseInt(trainingtileinstance.updatedat)).toLocaleDateString(trainingStatics.locale, trainingStatics.localeOptions);
      $(widgetRepresentation)
        ...
        .append(
          ...
          .append(
            ...
            .attr("id", trainingtileinstance.updatedat)
            .on('click', function () {
            ...
            .append(
              ...
              .append(
                $("<h3/>")
                .text(trainingtileinstance.name)
              )
              .append(
                $("<h4/>")
                .text("Date: " + trainingtileinstance.datetype)
              )
              .append(
                $("<h5/>")
