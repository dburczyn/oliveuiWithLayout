(function ($, OliveUI) {
  OliveUI.modules.new_brokerage_object_event_widget = function (config = {}) {
    ...
    function produceWidgetInstanceContent(createform) {
      ...
      widgetInstanceContent.picture = $(createform).find($('input[name="eventpicturefield"]')).val();
    ...
    function createFrontWidgetTile(renderdata,gridrendercontent) {
      ...
      var parsedcreatedat = new Date(parseInt(renderdata.createdat)).toLocaleDateString(eventStatics.locale, eventStatics.localeOptions);
      var parsedupdatedat = new Date(parseInt(renderdata.updatedat)).toLocaleDateString(eventStatics.locale, eventStatics.localeOptions);
      $(widgetRepresentation)
        ...
        .append(
          ...
          .css({
            ...
            "border-style": "solid",
            "border-width": "2px",
            "border-color": eventStatics.bgcolor
          })
          .append(
            $("<div/>")
